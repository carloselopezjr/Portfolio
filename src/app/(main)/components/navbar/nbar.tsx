  ...
  const borderColor =
    pathname === "/"
      ...
      : pathname === "/projects"
        ...
        : pathname === "/experience"
          ? "border-[#5148a4] text-black hover:border-[#9990af] hover:shadow-[0_0_12px_#9990af]"
          : pathname === "/about"
                ...
                >
                  <ul className="">
                    {navItems.map((item) => (
                      <li
                        key={item.label}
                        className={`hover:underline mt-2 decoration-frost hover:opacity-80 transition-all duration-300 ease-in-out ${pathname === item.href ? "underline decoration-[#aee7ff]" : ""
                          }`}
                      >
